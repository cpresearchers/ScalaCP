...
//
//
//public class S64BitSet2 implements IStateBitSet {
//
...
//
//
//    public IStateLong[] getWords() {
//        return words;
//    }
//
//    public void setWords(IStateLong[] w) {
//        for(int i=0;i<w.length;i++)
//            words[i].set(w[i].get());
//    }
//    public void setWords(Long w,int i) {
//        words[i].set(w);
//    }
//
//    /**
...
//     */
//    public S64BitSet2(IEnvironment environment) {
...
//     *                                    is negative.
//     */
//    public S64BitSet2(IEnvironment environment, int nbits) {
//        this.environment = environment;
//        this.wordsInUse = environment.makeInt(0);
...
//        expandTo(wordIndex);
//
////        words[wordIndex].set(words[wordIndex].get() | (1L << (63-bitIndex%64))); // Restores invariants
//        words[wordIndex].set(words[wordIndex].get() | (1L << -bitIndex-1)); // Restores invariants
//
//
//        if (CHECK) checkInvariants();
//    }
...
//
//        long firstWordMask = WORD_MASK >>> fromIndex%64;
////        long lastWordMask = WORD_MASK << (63-(toIndex-1)%64);
...
//            return;
//
////        words[wordIndex].set(words[wordIndex].get() & ~(1L << (63-bitIndex%64)));
//        words[wordIndex].set(words[wordIndex].get() & ~(1L << -bitIndex-1));
//
...
////                && ((words[wordIndex].get() & (1L << (63-bitIndex%64))) != 0);
//        return (wordIndex < wordsInUse.get())
//                && ((words[wordIndex].get() & (1L << -bitIndex-1)) != 0);
//    }
//
//    /**
...
//            return -1;
//
//        long word = words[u].get() & (WORD_MASK >>> fromIndex%64);
//
//        while (true) {
//            if (word != 0)
...
//            return length() - 1;
//
////        long word = words[u].get() & (WORD_MASK << (63-fromIndex%64));
//        long word = words[u].get() & (WORD_MASK << -fromIndex-1);
//
//        while (true) {
//            if (word != 0)
//                return (u + 1) * BITS_PER_WORD - 1 - Long.numberOfTrailingZeros(word);
//            if (u-- == 0)
//                return -1;
//            word = words[u].get();
//        }
...
//                (BITS_PER_WORD-Long.numberOfTrailingZeros(words[wiu - 1].get()));
//    }
//
//    /**
...
//
//    public void show(){
//        for (int i = 0; i <= wordsInUse.get() - 1; i++) {
...
//        if (!(obj instanceof S64BitSet2))
//            return false;
//        if (this == obj)
//            return true;
//
//        S64BitSet2 set = (S64BitSet2) obj;
//
//        if (CHECK) checkInvariants();

...
class CTpf_SSet(val id: Int, val arity: Int, val numVars: Int, val scope: Array[Var], val tuples: Array[Array[Int]], val helper: SearchHelper) extends Propagator[Var] {
  outer =>
...
//    println(" ini active threads:" + Thread.activeCount())
...
//    println(" ut active threads:" + Thread.activeCount())
...
//    println(" fd active threads:" + Thread.activeCount())

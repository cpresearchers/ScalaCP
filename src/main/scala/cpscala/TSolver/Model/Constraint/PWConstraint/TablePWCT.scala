...
class TablePWCT(val id: Int, val arity: Int, val num_vars: Int, val scope: Array[Var], val tuples: Array[Array[Int]], val helper: PWSearchHelper) extends fPWCPropagator {

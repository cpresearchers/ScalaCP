...
class TableSTRbit_2_1(val id: Int, val arity: Int, val num_vars: Int, val scope: Array[Var], val tuples: Array[Array[Int]], val helper: SearchHelper) extends Propagator[Var] {
  ...
  // 比特掩码，用以保存留值对应有效比特支持的逻辑运算结果，结果中bit为0表示无效，bit为1表示有效

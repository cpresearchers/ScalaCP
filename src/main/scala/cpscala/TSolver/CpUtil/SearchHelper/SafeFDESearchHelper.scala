...
//import java.util.concurrent.atomic.{AtomicIntegerArray, AtomicLong, AtomicLongArray}
//
//import cpscala.TSolver.Model.Constraint.IPConstraint.IPPropagator
//
//import scala.collection.mutable.ArrayBuffer
//
//class PFDESearchHelper(override val numVars: Int, override val numTabs: Int, val parallelism: Int) extends SearchHelper(numVars, numTabs) {
//  override val globalStamp: AtomicLong
//  val atomicTabStamp: AtomicLongArray = new AtomicLongArray(numTabs)
//  val atomicVarStamp: AtomicLongArray = new AtomicLongArray(numVars)
//

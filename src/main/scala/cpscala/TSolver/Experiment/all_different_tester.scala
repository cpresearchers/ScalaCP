...
object all_different_tester {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val all = new util.ArrayList[XVar]()
    all.add(new XVar(1, "a", Array[Int](1, 4, 5, 6, 7, 8, 9, 10, 12, 34, 65, 43)))
    all.add(new XVar(2, "b", Array[Int](1, 2, 6, 7, 5, 55, 44, 88)))
    all.add(new XVar(3, "c", Array[Int](2, 3, 4)))
    all.add(new XVar(4, "d", Array[Int](4)))
    all.add(new XVar(5, "e", Array[Int](1, 2, 4, 5, 78, 88, 99, 124, 115)))
    all.add(new XVar(6, "f", Array[Int](1, 2, 14, 15, 55, 34, 99, 124, 115, 888)))
    all.add(new XVar(7, "g", Array[Int](4, 5, 14, 55)))
    all.add(new XVar(8, "h", Array[Int](1)))
    all.add(new XVar(9, "i", Array[Int](1, 5, 4)))
    //

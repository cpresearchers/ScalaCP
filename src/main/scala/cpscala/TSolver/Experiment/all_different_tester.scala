...
import cpscala.TSolver.Model.Solver.AllDifferent.{AllDifferent_Li, AllDifferent_Regin, AllDifferent_Zhang, AllDifferent_Zhen}
...
//    all.add(e)
    ...
    val test = new AllDifferent_Li(all)
    test.Solve()
    //      println("---------------------zhen---------------")
